...
#CMD sleep infinity
CMD python main_test_swinir.py --task real_sr --training_patch_size 64 --scale 4 --noise 12  --folder_lq /opt/swinir/images/degraded --folder_gt /opt/swinir/images/originals \
--model_path /opt/swinir/images/model_zoo/003_realSR_BSRGAN_DFO_s64w8_SwinIR-M_x4_PSNR.pth
